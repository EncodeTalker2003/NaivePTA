...
public class PointerAnalysisCheat extends ProgramAnalysis<PointerAnalysisResult> {
    public static final String ID = "pku-pta-cheat";
    ...
    public PointerAnalysisCheat(AnalysisConfig config) {
        super(config);
        if (dumpPath.exists()) {
            dumpPath.delete();
        }
    ...
    public PointerAnalysisResult analyze() {
		...
		} else if ((objs.size() == 4) && (preprocess.test_pts.size() == 1)) {
